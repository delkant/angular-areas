...
ngAreas.directive("ngAreas", ['$parse', function ($parse) {
	return {
		...
		controller : function($scope, $element, $attrs) {
			    ...
			    var onAdd = function (){
			    	$scope.$eval($attrs.ngAreasOnAdd);
			    }
			    var onDelete = function (ev, boxId, areas, area){
			    	$scope.$eval($attrs.ngAreasOnRemove.replace('id', (typeof area.id==='undefined') ? '':area.id));
			    }
			    var onChange = function (ev, boxId, areas, area){
			   ...
			   var imageArea = function(parent, areaid) {
			    ...
			    imageSelectAreas.prototype.newArea = function (event) {
			        ...
			        this._areas[areaid] = imageArea(this, areaid);
			        if (event) {
			    ...
			    var execCommand = function (currentObject, command){
			    	if ( imageSelectAreas.prototype[command] ) { // Method call
			            var ret = imageSelectAreas.prototype[ command ].apply( selectAreas(currentObject), Array.prototype.slice.call( arguments, 1 ));
